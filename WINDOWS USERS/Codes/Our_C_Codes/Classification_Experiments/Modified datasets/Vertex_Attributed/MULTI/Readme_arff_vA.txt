...
The unique property for the database "IMDB-MULTI-vA" is:

p_(0)_(SrcVertex): (degree(SrcVertex) + |attrib(1,SrcVertex)|) % 3  
_____________________________________________________________________________
Command line for compiling the file: arffGraphs_multi_vA.c

gcc -Wall -Wl,--stack,536870912 -o arffGraphs_multi_vA.exe arffGraphs_multi_vA.c
_____________________________________________________________________________
Command line for executing the file: arffGraphs_multi_vA.exe

arffGraphs_multi_vA.exe DirectoryName NbProperties epsilon  MaxIterations Threshold OutputFile SaveInitHMMs SaveFinalHMMs DepthMaxDFS NbVW
_____________________________________________________________________________			  
Exemples of execution of the program: 

arffGraphs_multi_vA.exe IMDB-MULTI-vA 1 0.0 100 100.0 Output_IMDB-MULTI-vA.txt 0 0 1 1
_____________________________________________________________________________
