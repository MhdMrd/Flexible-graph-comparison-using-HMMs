...
_____________________________________________________________________________
Command line for executing the file: arffGraphs_multi_vL.exe

arffGraphs_multi_vL.exe DirectoryName NbProperties epsilon  MaxIterations Threshold OutputFile SaveInitHMMs SaveFinalHMMs DepthMaxDFS
_____________________________________________________________________________			  
Exemples of execution of the program: 

arffGraphs_multi_vL.exe IMDB-MULTI-vL 1 0.0 100 100.0 Output_IMDB-MULTI-vL.txt 0 0 1
_____________________________________________________________________________
