...
gcc -Wall -o arffGraphs.out arffGraphs.c
_____________________________________________________________________________
Command line for executing the file: arffGraphs.out

./arffGraphs.out DirectoryName NbProperties epsilon  MaxIterations Threshold OutputFile SaveInitHMMs SaveFinalHMMs NbSlicesNeighborhood DepthMaxDFS
_____________________________________________________________________________			  
Examples of execution of the program: 

./arffGraphs.out IMDB-BINARY 6 0.0 100 100.0 Output_IMDB-BINARY.txt 0 0 5 1
_____________________________________________________________________________
...
_____________________________________________________________________________
Execute the file "test.sh" in terminal to obtain the classification results of the Table 9 in [1]
