...
gcc -Wall -o arffGraphs_binary_vL.out arffGraphs_binary_vL.c
_____________________________________________________________________________
Command line for executing the file: arffGraphs_binary_vL.out

./arffGraphs_binary_vL.out DirectoryName NbProperties epsilon  MaxIterations Threshold OutputFile SaveInitHMMs SaveFinalHMMs DepthMaxDFS
_____________________________________________________________________________			  
Exemples of execution of the program: 

./arffGraphs_binary_vL.out IMDB-BINARY-vL 1 0.0 100 100.0 Output_IMDB-BINARY-vL.txt 0 0 1
_____________________________________________________________________________
