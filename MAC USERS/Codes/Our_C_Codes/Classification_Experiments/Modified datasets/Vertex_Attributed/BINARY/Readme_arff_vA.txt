...
gcc -Wall -o arffGraphs_binary_vA.out arffGraphs_binary_vA.c
_____________________________________________________________________________
Command line for executing the file: arffGraphs_binary_vA.out

./arffGraphs_binary_vA.out DirectoryName NbProperties epsilon  MaxIterations Threshold OutputFile SaveInitHMMs SaveFinalHMMs DepthMaxDFS NbVW
_____________________________________________________________________________			  
Exemples of execution of the program: 

./arffGraphs_binary_vA.out IMDB-BINARY-vA 1 0.0 100 100.0 Output_IMDB-BINARY-vA.txt 0 0 1 1
_____________________________________________________________________________
