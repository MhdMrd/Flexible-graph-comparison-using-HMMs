...
gcc -Wall -o arffGraphs_multi_vA.out arffGraphs_multi_vA.c
_____________________________________________________________________________
Command line for executing the file: arffGraphs_multi_vA.out

./arffGraphs_multi_vA.out DirectoryName NbProperties epsilon  MaxIterations Threshold OutputFile SaveInitHMMs SaveFinalHMMs DepthMaxDFS NbVW
_____________________________________________________________________________			  
Exemples of execution of the program: 

./arffGraphs_multi_vA.out IMDB-MULTI-vA 1 0.0 100 100.0 Output_IMDB-MULTI-vA.txt 0 0 1 1
_____________________________________________________________________________
